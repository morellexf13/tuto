...
import SpotifyTracker from "@pages/SpotifyTracker.vue";
...
const FAKE_OK_RESPONSE = {
    ...
    item: {
        ...
        name: "Ain't My Bitch",
        popularity: 47,
        preview_url: "https://p.scdn.co/mp3-preview/4bba3586d50d2aecb577227ea15ed8d5248fa1fb?cid=774b29d4f13844c495f206cafdad9c86",
        track_number: 1,
        type: "track",
...
const mountComponent = async() => {
    ...
    let component = shallowMount(SpotifyTracker, { router });
    await Vue.nextTick();
    return component;
};
